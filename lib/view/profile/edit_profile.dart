...
class EditProfile extends StatefulWidget {
  ...
  const EditProfile({super.key, required this.userProvider});
...
class _EditProfileState extends State<EditProfile> {
  ...
  void initState() {
    ...
    nameController =
        TextEditingController(text: widget.userProvider.clientModel!.fullName);
    bioController =
        TextEditingController(text: widget.userProvider.clientModel!.bio);
    super.initState();
  }
          ...
          child: SingleChildScrollView(
            child: Column(
              children: [
                ...
                // ~ Display name
                Text(
                  widget.userProvider.clientModel!.fullName.toString().tr,
                  style: GoogleFonts.blackOpsOne(
                    fontSize: 23.sp,
                    textStyle: Theme.of(context).textTheme.bodyMedium,
                    decorationColor: Colors.black,
                      ...
                      : Container(
                          ...
                          child: ElevatedButton(
                              ...
                              onPressed: () {
                                ...
                                firebaseAuthController.changeProfleData(
                                    context: context,
                                    nameController: nameController,
                                    bioController: bioController,
                                    userModelProvider: userProvider);
                              },
                              child: Text(
                                "Save".tr,
                                style: TextStyle(
